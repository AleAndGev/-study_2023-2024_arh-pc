...
author: "Aндриевский Александр Геворгович"
...
переходим в директорию в которой будем работать, 
Создаём текстовый файл с именем hello.asm и вводим в него программу печатающую Hello world!' 
Производим компиляцию, компоновку и запуск файла hello.asm 
...
![написание Компиляция упаковка и запуск файла lab4.asm ](image/4-1.png){#fig:003 width=70%}
